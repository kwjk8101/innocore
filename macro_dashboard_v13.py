...
v13.0 changes:
- Multi-page navigation (5 pages via sidebar): Overview, Markets & Sectors,
  Global Macro, Charts & Analysis, Calendar & News
- Visual overhaul: eliminated all awkward whitespace, replaced st.divider()
  with styled section separators, consistent padding/margins throughout
- New: Real Rate Monitor card (Fed Funds minus CPI — the #1 policy signal)
- New: DXY Strength Meter with regime interpretation on Overview
- New: Economic Conditions Summary panel — 6 traffic-light indicators at a glance
- New: Macro Momentum score — tracks direction of change across 8 indicators
- Section headers redesigned with accent glow lines and category labels
- All <br> spacers removed and replaced with proper CSS margin control
- Market price grid now unified 7-card row (no awkward 4+3 split)
- Page container max-width increased, padding normalized
============================================================
"""
